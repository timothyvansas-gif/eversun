  ...
  return (
    <>
      <button
        ...
        className={`${BTN_PILL_ACCENT} !px-[28px] w-full md:w-auto justify-center py-3 md:py-[10px] shrink-0 md:border md:border-line md:bg-transparent md:text-zinc-900 md:transition-[transform,border-color,background-color,color] md:hover:border-[#312019] md:hover:bg-transparent md:hover:text-zinc-900`}
      >
        Plan je moment
      </button>
