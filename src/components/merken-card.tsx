...
export default function MerkenCard() {
  return (
    <div className="w-full h-[362px] rounded-lg flex flex-col overflow-hidden" style={{ backgroundColor: '#B7B7A4', paddingTop: 'clamp(24px, 4vw, 40px)', paddingLeft: 'clamp(24px, 4vw, 40px)', paddingRight: 'clamp(24px, 4vw, 40px)' }}>
