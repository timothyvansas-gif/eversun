...
export default function MerkenCard() {
  return (
    <div className="w-full h-[362px] rounded-[12px] flex flex-col overflow-hidden" style={{ backgroundColor: '#DCD5C4', paddingTop: 'clamp(24px, 4vw, 40px)', paddingLeft: 'clamp(24px, 4vw, 40px)', paddingRight: 'clamp(24px, 4vw, 40px)' }}>
      ...
      <div className="relative flex-1 min-h-[160px] mt-4 overflow-hidden rounded-t-[12px]">
        <Image
          src={exlMerken}
