...
function AfspraakButton({ minuten, prijs }: { minuten: string; prijs: string }) {
          ...
          <div className="flex flex-col gap-6 xl:gap-16">
            ...
            <div className="flex flex-col xl:flex-row gap-6">
              <div className="flex-1 flex flex-col gap-6">
                <div className="relative min-h-[300px] xl:min-h-[320px] bg-zinc-100 rounded-lg flex items-center justify-center">
                  ...
                  <span className="absolute bottom-3 right-3 xl:bottom-6 xl:right-6 text-[13px] font-medium leading-none px-2.5 py-1.5 rounded-full" style={{ backgroundColor: "#FDC43F", color: "#111111" }}>2 banken</span>
                </div>
                <div className="flex flex-col gap-[10px] xl:pr-14">
                  ...
                  <AfspraakButton minuten="20 min" prijs="€ 19,50" />
                </div>
              </div>
              <div className="xl:hidden h-px my-2" style={{ backgroundColor: "#ece2d2", opacity: 0.5 }} />
              <div className="flex-1 flex flex-col gap-6">
                <div className="relative min-h-[300px] xl:min-h-[320px] bg-zinc-100 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <svg className="w-12 h-12 mx-auto mb-2 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col xl:flex-row gap-6">
              <div className="flex-1 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-[10px] xl:pr-14">
                  ...
                  <AfspraakButton minuten="20 min" prijs="€ 14,00" />
                </div>
              </div>
              <div className="xl:hidden h-px my-2" style={{ backgroundColor: "#ece2d2", opacity: 0.5 }} />
              <div className="flex-1 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-[10px] xl:pr-14">
                  ...
                  <AfspraakButton minuten="20 min" prijs="€ 12,00" />
                </div>
              </div>
            </div>
          </div>
