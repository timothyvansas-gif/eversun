        ...
        >
          ...
          <div className="relative">
            <button
              ...
              className="nav-link light cursor-pointer relative z-50 lg:!pr-0 lg:[&::after]:right-0"
            >
        ...
        <div className="flex-1 flex flex-col justify-end lg:justify-center lg:translate-y-15">
          ...
          <div className="mb-14 lg:mb-0">
            <div className="translate-y-4 lg:translate-y-8">
              ...
              <m.p
                className="block mt-3.5 md:mt-3 font-sans font-normal text-[16px] md:text-[20px] leading-[25px] md:leading-[30px]"
                variants={fadeUp}
                initial="hidden"
                animate="visible"
                custom={0.6}
