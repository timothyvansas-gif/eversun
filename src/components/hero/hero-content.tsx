            ...
            <div className="translate-y-4 lg:translate-y-0">
              ...
              <div className="w-fit">
                <m.h1
                  ...
                  animate="visible"
                  custom={0.3}
                  className="font-alice font-normal tracking-[-0.02em] lg:tracking-[-3px] text-[clamp(32px,7.5vw,88px)] leading-[clamp(40px,10vw,94px)] lg:text-[68px] lg:leading-[1.2] 2xl:text-[68px] 2xl:leading-[1.2]"
                ...
                <m.p
                  className="hidden lg:block w-0 min-w-full mt-2.5 md:mt-3 lg:mt-4 font-sans font-normal text-[15px] md:text-[20px] lg:text-[18px] leading-[25px] md:leading-[30px] lg:leading-[34px]"
                  variants={fadeUp}
                  initial="hidden"
                  animate="visible"
                  custom={0.6}
