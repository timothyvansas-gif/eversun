...
export default function HeroLines() {
  return (
    <motion.svg
      ...
      className="absolute left-0 -bottom-2 md:-bottom-2 w-full"
    ...
    >
      <motion.path
        ...
        className="[stroke-width:3] md:[stroke-width:3]"
      ...
      <motion.path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="[stroke-width:3] md:[stroke-width:3] translate-y-[5px] md:translate-y-[4px]"
        initial={{ pathLength: 0, opacity: 0 }}
        animate={{ pathLength: 1, opacity: 1 }}
