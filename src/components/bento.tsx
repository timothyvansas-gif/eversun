...
export default function Bento() {
  ...
  return (
    <m.section
      ...
      className="relative w-full max-w-[1280px] mx-auto pt-4 pb-16 md:pt-8 xl:pt-16 min-h-[500px] scroll-mt-14 lg:-scroll-mt-6"
    ...
    >
      ...
      >
        <m.div variants={cardVariants} custom={-1}>
          ...
          <p className="mt-2 text-[15px] lg:text-[18px] font-normal xl:font-medium leading-[24px] lg:leading-[30px] tracking-[-0.02em] text-[#6f6f78]">
